...
export const INITIAL_USERS: UserAccount[] = [
  ...
  // 4. Wali Kelas (1 Akun Terpadu Walas XI Farmasi & Guru Pengajar: Apt. Siti Rohmah, S.Farm.)
  {
    id: 'USR-WALAS-XIFAR',
    teacherId: 'GUR-002',
    ...
    jabatan: 'Wali Kelas XI Farmasi & Guru Pengajar',
    telepon: '081398765432',
    statusAktif: true,
  },
  // 5. Wali Kelas (1 Akun Terpadu Walas X & Guru Pengajar: Budi Santoso, S.Pd.)
  {
    id: 'USR-WALAS-X',
    teacherId: 'GUR-001',
    ...
    password: 'walas123',
    rombelId: 'ROMBEL-X',
    jabatan: 'Wali Kelas X & Guru Pengajar',
    telepon: '081287654321',
    statusAktif: true,
  },
  // 5b. Wali Kelas (1 Akun Terpadu Walas XI Keperawatan & Guru: Ns. Ratna Dewi, S.Kep.)
  {
    id: 'USR-WALAS-XIKEP',
    teacherId: 'GUR-003',
    email: 'ratna.dewi@smkhusada.sch.id',
    username: 'walas_xikep',
    nama: 'Ns. Ratna Dewi, S.Kep.',
    role: 'walas',
    password: 'walas123',
    rombelId: 'ROMBEL-XI-KEP',
    jabatan: 'Wali Kelas XI Keperawatan & Guru Pengajar',
    telepon: '085712345678',
    statusAktif: true,
  },
  // 5c. Wali Kelas (1 Akun Terpadu Walas XII Farmasi & Guru: Apt. Hendra Pratama, M.Farm.)
  {
    id: 'USR-WALAS-XIIFAR',
    teacherId: 'GUR-004',
    email: 'hendra.pratama@smkhusada.sch.id',
    username: 'walas_xiifar',
    nama: 'Apt. Hendra Pratama, M.Farm.',
    role: 'walas',
    password: 'walas123',
    rombelId: 'ROMBEL-XII-FAR',
    jabatan: 'Wali Kelas XII Farmasi & Guru Pengajar',
    telepon: '081901234567',
    statusAktif: true,
  },
  // 5d. Wali Kelas (1 Akun Terpadu Walas XII Keperawatan & Guru: Ns. Dian Anggraeni, S.Kep.)
  {
    id: 'USR-WALAS-XIIKEP',
    teacherId: 'GUR-005',
    email: 'dian.anggraeni@smkhusada.sch.id',
    username: 'walas_xiikep',
    nama: 'Ns. Dian Anggraeni, S.Kep.',
    role: 'walas',
    password: 'walas123',
    rombelId: 'ROMBEL-XII-KEP',
    jabatan: 'Wali Kelas XII Keperawatan & Guru Pengajar',
